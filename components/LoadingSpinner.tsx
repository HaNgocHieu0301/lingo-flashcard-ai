...
const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({ message = "Generating Cards..." }) => {
  return (
    <div className="flex justify-center items-center my-8" aria-label="Loading content">
      ...
      <span className="text-lg font-medium text-slate-700 dark:text-slate-300">{message}</span>
    </div>
  );
};
